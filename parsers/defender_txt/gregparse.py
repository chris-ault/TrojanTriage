...
def cleanRes(object):
    object.resources = object.resources.strip("...}").strip('}').strip('{')


def printRes(object):
    object.resourceList = object.resources.split(',')
    print str(num) + str(object.resourceList)


def printObj(object):
    print "cat" + str(object.categoryID)
    print "threatID" + str(object.threatID)
    # print "resc" + str(object.resourceList)
